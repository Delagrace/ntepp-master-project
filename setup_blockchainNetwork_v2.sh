...
if [ "$(cat configFiles/peersDeployment.yaml | grep -c tcp://docker:2375)" != "0" ]; then
    ...
    kubectl create -f docker-volume.yaml
    kubectl create -f dockercert-volume.yaml
    kubectl create -f docker.yaml
    sleep 5
...
if [ "$(kubectl get pvc | grep shared-pvc | awk '{print $2}')" != "Bound" ]; then
    ...
    if [ "$1" == "--paid" ]; then
        ...
        echo "Running: kubectl create -f createVolume.yaml
        echo "Running: kubectl delete -f createVolume.yaml
...
echo "Running: kubectl create -f copyArtifactsJob.yaml
echo "Running: kubectl delete -f copyArtifactsJob.yaml
kubectl create -f ${KUBECONFIG_FOLDER}/copyArtifactsJob.yaml
#kubectl create -f copyArtifactsJob.yaml
...
kubectl delete -f generateArtifactsJob.yaml
...
echo "Running: kubectl create -f blockchain-services.yaml"
echo "Running: kubectl delete -f blockchain-services.yaml
...
echo "Running: kubectl create -f peersDeployment.yaml
echo "Running: kubectl delete -f peersDeployment.yaml
...
echo "Running: kubectl create -f create_channel.yaml
echo "Running: kubectl delete -f create_channel.yaml
...
echo "Running: kubectl create -f join_channel.yaml
echo "Running: kubectl delete -f join_channel.yaml
...
echo "Running: kubectl create -f chaincode_install.yaml
echo "Running: kubectl delete -f chaincode_install.yaml
...
echo "Running: kubectl create -f chaincode_instantiate.yaml
echo "Running: kubectl delete -f chaincode_instantiate.yaml
