...
pattern = r".*Committed block \[\d+\] with \d+ transaction\(s\) in \d+ms.*"

# Check if the log file exists
log_file_path = 'C:/cygwin64/home/delag/project/blockchain-network-on-kubernetes-correct/data/otherlogs/logsOrg1peer1.json'
...
with open('C:/cygwin64/home/delag/project/blockchain-network-on-kubernetes-correct/data/otherlogs/peerCommitMetricOrg1peer1.json', 'w') as json_file:
