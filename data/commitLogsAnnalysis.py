...
def process_log_file(file_path):
    ...
    with open(file_path, 'r') as file:
        for line in file:
            if "[channel0] Committed block" in line:
                start_index = line.find("with") + len("with")
                end_index = line.find("transaction(s)")
...
def main():
    log_file_path = "C:/cygwin64/home/delag/project/blockchain-network-on-kubernetes-correct/data/logs/parsed-logs/peerCommitMetricOrg1peer2.json"
